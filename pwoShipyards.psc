...
Event OnInit()
	Debug.Messagebox("Expanded Shipyard Access script has been successfully activated! Please do not run this command again, or you will have multiple scripts attached to your character. This script will run once every time you load your save. Thank you for downloading!")
	Maintenance()
EndEvent
...
Function GetVersion() global
	Float fVersion = 1.00
	Debug.Messagebox("ESA Version: " + fVersion)
EndFunction
